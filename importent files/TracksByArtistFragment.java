...
public class TracksByArtistFragment extends Fragment {
    ...
    public static TracksByArtistFragment newInstance(String artistName) {
        TracksByArtistFragment fragment = new TracksByArtistFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvTitle.setText("Исполнитель: " + artistName);
        ...
        viewModel.getTracksForArtist(artistName).observe(getViewLifecycleOwner(), tracks -> {
